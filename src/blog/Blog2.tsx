    ...
    <>
      <Box sx={{
        ...
        <Container component="section">
          <Typography variant="h1" sx={{ fontSize: 40, my: 5 }}>TuringTestChat Developer Update #1</Typography>
          ...
          <Box component="img" alt="TuringTestChat logo" src="../b1homepage.png" sx={{ maxWidth: "100%", color: "#e9e9e9", my: 2 }} />
          ...
          <Box component="img" alt="TuringTestChat logo" src="../b1login.png" sx={{ maxWidth: "100%", color: "#e9e9e9", my: 2 }} />
          ...
          <Box component="img" alt="TuringTestChat logo" src="../b1chat.png" sx={{ maxWidth: "100%", color: "#e9e9e9", my: 2 }} />
          ...
          To monetize TuringTestChat, there will be a credit system.
          ...
          TuringTestChat will always offer at least a few credits for free every day.<p />
