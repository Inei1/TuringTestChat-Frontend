  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Engineering Blog 2: Websocket Chat Application | Turing Test Chat" />
        ...
        <meta name="twitter:title" content="Engineering Blog 2: Websocket Chat Application | Turing Test Chat" />
